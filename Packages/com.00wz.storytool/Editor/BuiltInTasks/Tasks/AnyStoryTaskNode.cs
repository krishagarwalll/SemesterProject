...
{
    [StoryTaskNodeDrawer(typeof(AnyStoryTask))]
    public class AnyStoryTaskNode : StoryTaskNode
    {
        public AnyStoryTaskNode(SerializedProperty taskProperty) : base(taskProperty)
        {
        }
        ...
        protected override void BuildContent()
        {
            ...
            tooltip = "Any: activates output each time any input trigger fires.";
        }
    }
}